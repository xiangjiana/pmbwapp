...
class GameObRecommendPostRespModel {
  GameObRecommendPostRespModel({
    required this.data,
  });

  factory GameObRecommendPostRespModel.fromJson(Map<String, dynamic> jsonRes) {
    final List<GameObRecommendPostRespModelData>? data = jsonRes['data'] is List ? <GameObRecommendPostRespModelData>[] : null;
    if (data != null) {
      for (final dynamic item in jsonRes['data']!) {
        if (item != null) {
          data.add(GameObRecommendPostRespModelData.fromJson(asT<Map<String, dynamic>>("data", item)!));
        }
      }
    }
    return GameObRecommendPostRespModel(
      data: data == null ? [] : data,
    );
  }

  List<GameObRecommendPostRespModelData> data;
...
class GameObRecommendPostRespModelData {
  GameObRecommendPostRespModelData({
    required this.bo,
  ...
  factory GameObRecommendPostRespModelData.fromJson(Map<String, dynamic> jsonRes) {
    final List<Odds>? odds = jsonRes['odds'] is List ? <Odds>[] : null;
    if (odds != null) {
      for (final dynamic item in jsonRes['odds']!) {
        if (item != null) {
          odds.add(Odds.fromJson(asT<Map<String, dynamic>>("odds", item)!));
        }
      }
    }
    return GameObRecommendPostRespModelData(
...
class Odds {
  ...
  factory Odds.fromJson(Map<String, dynamic> jsonRes) => Odds(
        enName: jsonRes['en_name'] == null
            ? ''
            : asT<String>("en_name", jsonRes['en_name'])!,
        id: jsonRes['id'] == null ? '' : asT<String>("id", jsonRes['id'])!,
