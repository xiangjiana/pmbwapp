...
class GameMultiAgentProxyQueryMemberNetAmountDetailDayPostRespModel {
  GameMultiAgentProxyQueryMemberNetAmountDetailDayPostRespModel({
    required this.data,
  });

  factory GameMultiAgentProxyQueryMemberNetAmountDetailDayPostRespModel.fromJson(
      Map<String, dynamic> jsonRes) {
    final List<GameMultiAgentProxyQueryMemberNetAmountDetailDayPostRespModelData>? data = jsonRes['data'] is List ? <GameMultiAgentProxyQueryMemberNetAmountDetailDayPostRespModelData>[] : null;
    if (data != null) {
      for (final dynamic item in jsonRes['data']!) {
        if (item != null) {
          data.add(GameMultiAgentProxyQueryMemberNetAmountDetailDayPostRespModelData.fromJson(asT<Map<String, dynamic>>("data", item)!));
        }
      }
    }
    return GameMultiAgentProxyQueryMemberNetAmountDetailDayPostRespModel(
      data: data == null ? [] : data,
    );
  }

  List<GameMultiAgentProxyQueryMemberNetAmountDetailDayPostRespModelData> data;
...
class GameMultiAgentProxyQueryMemberNetAmountDetailDayPostRespModelData {
  GameMultiAgentProxyQueryMemberNetAmountDetailDayPostRespModelData({
  ...
  factory GameMultiAgentProxyQueryMemberNetAmountDetailDayPostRespModelData.fromJson(Map<String, dynamic> jsonRes) => GameMultiAgentProxyQueryMemberNetAmountDetailDayPostRespModelData(
