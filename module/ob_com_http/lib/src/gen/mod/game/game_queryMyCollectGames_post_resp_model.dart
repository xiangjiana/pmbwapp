...
class GameQueryMyCollectGamesPostRespModel {
  GameQueryMyCollectGamesPostRespModel({
    required this.data,
  });

  factory GameQueryMyCollectGamesPostRespModel.fromJson(
      Map<String, dynamic> jsonRes) {
    final List<GameQueryMyCollectGamesPostRespModelData>? data = jsonRes['data'] is List ? <GameQueryMyCollectGamesPostRespModelData>[] : null;
    if (data != null) {
      for (final dynamic item in jsonRes['data']!) {
        if (item != null) {
          data.add(GameQueryMyCollectGamesPostRespModelData.fromJson(asT<Map<String, dynamic>>("data", item)!));
        }
      }
    }
    return GameQueryMyCollectGamesPostRespModel(
      data: data == null ? [] : data,
    );
  }

  List<GameQueryMyCollectGamesPostRespModelData> data;
...
class GameQueryMyCollectGamesPostRespModelData {
  GameQueryMyCollectGamesPostRespModelData({
  ...
  factory GameQueryMyCollectGamesPostRespModelData.fromJson(Map<String, dynamic> jsonRes) => GameQueryMyCollectGamesPostRespModelData(
