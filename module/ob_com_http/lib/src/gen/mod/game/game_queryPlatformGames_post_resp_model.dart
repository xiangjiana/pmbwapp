...
class GameQueryPlatformGamesPostRespModel {
  GameQueryPlatformGamesPostRespModel({
    required this.data,
  });

  factory GameQueryPlatformGamesPostRespModel.fromJson(
      Map<String, dynamic> jsonRes) {
    final List<GameQueryPlatformGamesPostRespModelData>? data = jsonRes['data'] is List ? <GameQueryPlatformGamesPostRespModelData>[] : null;
    if (data != null) {
      for (final dynamic item in jsonRes['data']!) {
        if (item != null) {
          data.add(GameQueryPlatformGamesPostRespModelData.fromJson(asT<Map<String, dynamic>>("data", item)!));
        }
      }
    }
    return GameQueryPlatformGamesPostRespModel(
      data: data == null ? [] : data,
    );
  }

  List<GameQueryPlatformGamesPostRespModelData> data;
...
class GameQueryPlatformGamesPostRespModelData {
  GameQueryPlatformGamesPostRespModelData({
  ...
  factory GameQueryPlatformGamesPostRespModelData.fromJson(Map<String, dynamic> jsonRes) => GameQueryPlatformGamesPostRespModelData(
