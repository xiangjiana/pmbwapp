...
class GameQueryGameByGameNamePostRespModel {
  GameQueryGameByGameNamePostRespModel({
    required this.data,
  });

  factory GameQueryGameByGameNamePostRespModel.fromJson(
      Map<String, dynamic> jsonRes) {
    final List<GameQueryGameByGameNamePostRespModelData>? data = jsonRes['data'] is List ? <GameQueryGameByGameNamePostRespModelData>[] : null;
    if (data != null) {
      for (final dynamic item in jsonRes['data']!) {
        if (item != null) {
          data.add(GameQueryGameByGameNamePostRespModelData.fromJson(asT<Map<String, dynamic>>("data", item)!));
        }
      }
    }
    return GameQueryGameByGameNamePostRespModel(
      data: data == null ? [] : data,
    );
  }

  List<GameQueryGameByGameNamePostRespModelData> data;
...
class GameQueryGameByGameNamePostRespModelData {
  GameQueryGameByGameNamePostRespModelData({
  ...
  factory GameQueryGameByGameNamePostRespModelData.fromJson(Map<String, dynamic> jsonRes) => GameQueryGameByGameNamePostRespModelData(
