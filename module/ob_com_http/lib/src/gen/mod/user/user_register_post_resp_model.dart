...
class UserRegisterPostRespModel {
  UserRegisterPostRespModel({
    required this.memberInfo,
    required this.token,
  });

  factory UserRegisterPostRespModel.fromJson(Map<String, dynamic> jsonRes) =>
      UserRegisterPostRespModel(
        memberInfo: jsonRes["memberInfo"] == null
            ? UserRegisterPostRespModelMemberInfo.fromJson({})
            : UserRegisterPostRespModelMemberInfo.fromJson(
  ...
  UserRegisterPostRespModelMemberInfo memberInfo;
  String token = '';
...
class UserRegisterPostRespModelMemberInfo {
  UserRegisterPostRespModelMemberInfo({
  ...
  factory UserRegisterPostRespModelMemberInfo.fromJson(
