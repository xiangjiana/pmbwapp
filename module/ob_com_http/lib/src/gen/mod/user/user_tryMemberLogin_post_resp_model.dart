...
class UserTryMemberLoginPostRespModel {
  UserTryMemberLoginPostRespModel({
    required this.memberInfo,
    required this.token,
  });

  factory UserTryMemberLoginPostRespModel.fromJson(
          Map<String, dynamic> jsonRes) =>
      UserTryMemberLoginPostRespModel(
        memberInfo: jsonRes["memberInfo"] == null
            ? UserTryMemberLoginPostRespModelMemberInfo.fromJson({})
            : UserTryMemberLoginPostRespModelMemberInfo.fromJson(asT<Map<String, dynamic>>(
  ...
  UserTryMemberLoginPostRespModelMemberInfo memberInfo;
  String token = '';
...
class UserTryMemberLoginPostRespModelMemberInfo {
  UserTryMemberLoginPostRespModelMemberInfo({
  ...
  factory UserTryMemberLoginPostRespModelMemberInfo.fromJson(Map<String, dynamic> jsonRes) => UserTryMemberLoginPostRespModelMemberInfo(
