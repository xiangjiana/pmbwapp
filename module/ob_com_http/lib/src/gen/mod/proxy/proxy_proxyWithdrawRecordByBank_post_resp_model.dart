...
class ProxyProxyWithdrawRecordByBankPostRespModel {
  ProxyProxyWithdrawRecordByBankPostRespModel({
  ...
  factory ProxyProxyWithdrawRecordByBankPostRespModel.fromJson(
      Map<String, dynamic> jsonRes) {
    final List<ProxyProxyWithdrawRecordByBankPostRespModelRecord>? record = jsonRes['record'] is List ? <ProxyProxyWithdrawRecordByBankPostRespModelRecord>[] : null;
    if (record != null) {
      for (final dynamic item in jsonRes['record']!) {
        if (item != null) {
          record
              .add(ProxyProxyWithdrawRecordByBankPostRespModelRecord.fromJson(asT<Map<String, dynamic>>("record", item)!));
        }
      }
    }
    return ProxyProxyWithdrawRecordByBankPostRespModel(
      ...
      summary: jsonRes["summary"] == null
          ? ProxyProxyWithdrawRecordByBankPostRespModelSummary.fromJson({})
          : ProxyProxyWithdrawRecordByBankPostRespModelSummary.fromJson(
  ...
  int pageNum = 0;
  int pageSize = 0;
  List<ProxyProxyWithdrawRecordByBankPostRespModelRecord> record;
  ProxyProxyWithdrawRecordByBankPostRespModelSummary summary;
  int totalPage = 0;
  int totalRecord = 0;
...
class ProxyProxyWithdrawRecordByBankPostRespModelRecord {
  ProxyProxyWithdrawRecordByBankPostRespModelRecord({
  ...
  factory ProxyProxyWithdrawRecordByBankPostRespModelRecord.fromJson(Map<String, dynamic> jsonRes) => ProxyProxyWithdrawRecordByBankPostRespModelRecord(
...
class ProxyProxyWithdrawRecordByBankPostRespModelSummary {
  ProxyProxyWithdrawRecordByBankPostRespModelSummary({
  ...
  factory ProxyProxyWithdrawRecordByBankPostRespModelSummary.fromJson(Map<String, dynamic> jsonRes) => ProxyProxyWithdrawRecordByBankPostRespModelSummary(
