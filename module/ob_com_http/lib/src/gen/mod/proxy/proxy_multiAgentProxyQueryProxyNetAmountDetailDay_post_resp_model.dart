...
class ProxyMultiAgentProxyQueryProxyNetAmountDetailDayPostRespModel {
  ProxyMultiAgentProxyQueryProxyNetAmountDetailDayPostRespModel({
    required this.data,
  });

  factory ProxyMultiAgentProxyQueryProxyNetAmountDetailDayPostRespModel.fromJson(
      Map<String, dynamic> jsonRes) {
    final List<ProxyMultiAgentProxyQueryProxyNetAmountDetailDayPostRespModelData>? data = jsonRes['data'] is List ? <ProxyMultiAgentProxyQueryProxyNetAmountDetailDayPostRespModelData>[] : null;
    if (data != null) {
      for (final dynamic item in jsonRes['data']!) {
        if (item != null) {
          data.add(ProxyMultiAgentProxyQueryProxyNetAmountDetailDayPostRespModelData.fromJson(asT<Map<String, dynamic>>("data", item)!));
        }
      }
    }
    return ProxyMultiAgentProxyQueryProxyNetAmountDetailDayPostRespModel(
      data: data == null ? [] : data,
    );
  }

  List<ProxyMultiAgentProxyQueryProxyNetAmountDetailDayPostRespModelData> data;
...
class ProxyMultiAgentProxyQueryProxyNetAmountDetailDayPostRespModelData {
  ProxyMultiAgentProxyQueryProxyNetAmountDetailDayPostRespModelData({
  ...
  factory ProxyMultiAgentProxyQueryProxyNetAmountDetailDayPostRespModelData.fromJson(Map<String, dynamic> jsonRes) => ProxyMultiAgentProxyQueryProxyNetAmountDetailDayPostRespModelData(
