...
class ProxyProxyMessageDeletePostReqModel {
  ProxyProxyMessageDeletePostReqModel({
    required this.messageIdList,
  });

  factory ProxyProxyMessageDeletePostReqModel.fromJson(
    ...
    return ProxyProxyMessageDeletePostReqModel(
