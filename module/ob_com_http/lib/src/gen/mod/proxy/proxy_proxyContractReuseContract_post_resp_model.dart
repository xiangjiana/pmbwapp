...
class ProxyProxyContractReuseContractPostRespModel {
  ProxyProxyContractReuseContractPostRespModel({
    required this.data,
  });

  factory ProxyProxyContractReuseContractPostRespModel.fromJson(
      Map<String, dynamic> jsonRes) {
    final List<ProxyProxyContractReuseContractPostRespModelData>? data = jsonRes['data'] is List ? <ProxyProxyContractReuseContractPostRespModelData>[] : null;
    if (data != null) {
      for (final dynamic item in jsonRes['data']!) {
        if (item != null) {
          data.add(ProxyProxyContractReuseContractPostRespModelData.fromJson(asT<Map<String, dynamic>>("data", item)!));
        }
      }
    }
    return ProxyProxyContractReuseContractPostRespModel(
      data: data == null ? [] : data,
    );
  }

  List<ProxyProxyContractReuseContractPostRespModelData> data;
...
class ProxyProxyContractReuseContractPostRespModelData {
  ProxyProxyContractReuseContractPostRespModelData({
  ...
  factory ProxyProxyContractReuseContractPostRespModelData.fromJson(Map<String, dynamic> jsonRes) {
    final List<ProxyProxyContractReuseContractPostRespModelContractDetailRespList>? contractDetailRespList =
        jsonRes['contractDetailRespList'] is List
            ? <ProxyProxyContractReuseContractPostRespModelContractDetailRespList>[]
            : null;
    if (contractDetailRespList != null) {
      for (final dynamic item in jsonRes['contractDetailRespList']!) {
        if (item != null) {
          contractDetailRespList.add(ProxyProxyContractReuseContractPostRespModelContractDetailRespList.fromJson(
              asT<Map<String, dynamic>>("contractDetailRespList", item)!));
        }
      }
    }
    return ProxyProxyContractReuseContractPostRespModelData(
  ...
  List<ProxyProxyContractReuseContractPostRespModelContractDetailRespList> contractDetailRespList;
...
class ProxyProxyContractReuseContractPostRespModelContractDetailRespList {
  ProxyProxyContractReuseContractPostRespModelContractDetailRespList({
  ...
  factory ProxyProxyContractReuseContractPostRespModelContractDetailRespList.fromJson(Map<String, dynamic> jsonRes) =>
      ProxyProxyContractReuseContractPostRespModelContractDetailRespList(
