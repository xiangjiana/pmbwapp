...
class ProxyRebateDetailPagePostRespModel {
  ProxyRebateDetailPagePostRespModel({
  ...
  factory ProxyRebateDetailPagePostRespModel.fromJson(
      Map<String, dynamic> jsonRes) {
    final List<ProxyRebateDetailPagePostRespModelRecord>? record = jsonRes['record'] is List ? <ProxyRebateDetailPagePostRespModelRecord>[] : null;
    if (record != null) {
      for (final dynamic item in jsonRes['record']!) {
        if (item != null) {
          record
              .add(ProxyRebateDetailPagePostRespModelRecord.fromJson(asT<Map<String, dynamic>>("record", item)!));
        }
      }
    }
    return ProxyRebateDetailPagePostRespModel(
  ...
  int pageNum = 0;
  int pageSize = 0;
  List<ProxyRebateDetailPagePostRespModelRecord> record;
  Object summary;
  int totalPage = 0;
  int totalRecord = 0;
...
class ProxyRebateDetailPagePostRespModelRecord {
  ProxyRebateDetailPagePostRespModelRecord({
  ...
  factory ProxyRebateDetailPagePostRespModelRecord.fromJson(Map<String, dynamic> jsonRes) => ProxyRebateDetailPagePostRespModelRecord(
