...
class DiscountSponsorPostRespModel {
  DiscountSponsorPostRespModel({
    required this.data,
  });

  factory DiscountSponsorPostRespModel.fromJson(Map<String, dynamic> jsonRes) {
    final List<DiscountSponsorPostRespModelData>? data = jsonRes['data'] is List ? <DiscountSponsorPostRespModelData>[] : null;
    if (data != null) {
      for (final dynamic item in jsonRes['data']!) {
        if (item != null) {
          data.add(DiscountSponsorPostRespModelData.fromJson(asT<Map<String, dynamic>>("data", item)!));
        }
      }
    }
    return DiscountSponsorPostRespModel(
      data: data == null ? [] : data,
    );
  }

  List<DiscountSponsorPostRespModelData> data;
...
class DiscountSponsorPostRespModelData {
  DiscountSponsorPostRespModelData({
  ...
  factory DiscountSponsorPostRespModelData.fromJson(Map<String, dynamic> jsonRes) => DiscountSponsorPostRespModelData(
