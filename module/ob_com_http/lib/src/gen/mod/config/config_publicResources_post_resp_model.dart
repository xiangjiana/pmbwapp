...
class ConfigPublicResourcesPostRespModel {
  ConfigPublicResourcesPostRespModel({
    required this.data,
  });

  factory ConfigPublicResourcesPostRespModel.fromJson(
      Map<String, dynamic> jsonRes) {
    final List<ConfigPublicResourcesPostRespModelData>? data = jsonRes['data'] is List ? <ConfigPublicResourcesPostRespModelData>[] : null;
    if (data != null) {
      for (final dynamic item in jsonRes['data']!) {
        if (item != null) {
          data.add(ConfigPublicResourcesPostRespModelData.fromJson(asT<Map<String, dynamic>>("data", item)!));
        }
      }
    }
    return ConfigPublicResourcesPostRespModel(
      data: data == null ? [] : data,
    );
  }

  List<ConfigPublicResourcesPostRespModelData> data;
...
class ConfigPublicResourcesPostRespModelData {
  ConfigPublicResourcesPostRespModelData({
  ...
  factory ConfigPublicResourcesPostRespModelData.fromJson(Map<String, dynamic> jsonRes) => ConfigPublicResourcesPostRespModelData(
