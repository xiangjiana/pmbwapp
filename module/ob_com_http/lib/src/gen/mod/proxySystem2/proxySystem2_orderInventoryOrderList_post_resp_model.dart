...
class ProxySystem2OrderInventoryOrderListPostRespModel {
  ProxySystem2OrderInventoryOrderListPostRespModel({
  ...
  factory ProxySystem2OrderInventoryOrderListPostRespModel.fromJson(
      Map<String, dynamic> jsonRes) {
    final List<ProxySystem2OrderInventoryOrderListPostRespModel_Record>? record = jsonRes['record'] is List ? <ProxySystem2OrderInventoryOrderListPostRespModel_Record>[] : null;
    if (record != null) {
      for (final dynamic item in jsonRes['record']!) {
        if (item != null) {
          record
              .add(ProxySystem2OrderInventoryOrderListPostRespModel_Record.fromJson(asT<Map<String, dynamic>>("record", item)!));
        }
      }
    }
    return ProxySystem2OrderInventoryOrderListPostRespModel(
      ...
      summary: jsonRes["summary"] == null
          ? ProxySystem2OrderInventoryOrderListPostRespModel_Summary.fromJson({})
          : ProxySystem2OrderInventoryOrderListPostRespModel_Summary.fromJson(
  ...
  int pageNum = 0;
  int pageSize = 0;
  List<ProxySystem2OrderInventoryOrderListPostRespModel_Record> record;
  ProxySystem2OrderInventoryOrderListPostRespModel_Summary summary;
  int totalPage = 0;
  int totalRecord = 0;
...
class ProxySystem2OrderInventoryOrderListPostRespModel_Record {
  ProxySystem2OrderInventoryOrderListPostRespModel_Record({
  ...
  factory ProxySystem2OrderInventoryOrderListPostRespModel_Record.fromJson(Map<String, dynamic> jsonRes) {
    final List<ProxySystem2OrderInventoryOrderListPostRespModel_Detail>? detail = jsonRes['detail'] is List ? <ProxySystem2OrderInventoryOrderListPostRespModel_Detail>[] : null;
    if (detail != null) {
      for (final dynamic item in jsonRes['detail']!) {
        if (item != null) {
          detail
              .add(ProxySystem2OrderInventoryOrderListPostRespModel_Detail.fromJson(asT<Map<String, dynamic>>("detail", item)!));
        }
      }
    }
    return ProxySystem2OrderInventoryOrderListPostRespModel_Record(
  ...
  String createAt = '';
  List<ProxySystem2OrderInventoryOrderListPostRespModel_Detail> detail;
  String id = '';
  String matchName = '';
  double maxWin = 0.0;
  String memberName = '';
...
class ProxySystem2OrderInventoryOrderListPostRespModel_Detail {
  ProxySystem2OrderInventoryOrderListPostRespModel_Detail({
  ...
  factory ProxySystem2OrderInventoryOrderListPostRespModel_Detail.fromJson(Map<String, dynamic> jsonRes) => ProxySystem2OrderInventoryOrderListPostRespModel_Detail(
...
class ProxySystem2OrderInventoryOrderListPostRespModel_Summary {
  ProxySystem2OrderInventoryOrderListPostRespModel_Summary({
    required this.sportNames,
  });

  factory ProxySystem2OrderInventoryOrderListPostRespModel_Summary.fromJson(Map<String, dynamic> jsonRes) {
    ...
    return ProxySystem2OrderInventoryOrderListPostRespModel_Summary(
