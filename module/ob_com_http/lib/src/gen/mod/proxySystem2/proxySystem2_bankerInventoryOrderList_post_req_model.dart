...
class ProxySystem2BankerInventoryOrderListPostReqModel {
  ProxySystem2BankerInventoryOrderListPostReqModel({
  ...
  factory ProxySystem2BankerInventoryOrderListPostReqModel.fromJson(
