...
class ProxySystem2MemberGameRecordDetailPostRespModel {
  ProxySystem2MemberGameRecordDetailPostRespModel({
  ...
  factory ProxySystem2MemberGameRecordDetailPostRespModel.fromJson(
      Map<String, dynamic> jsonRes) {
    final List<ProxySystem2MemberGameRecordDetailPostRespModel_Record>? record = jsonRes['record'] is List ? <ProxySystem2MemberGameRecordDetailPostRespModel_Record>[] : null;
    if (record != null) {
      for (final dynamic item in jsonRes['record']!) {
        if (item != null) {
          record
              .add(ProxySystem2MemberGameRecordDetailPostRespModel_Record.fromJson(asT<Map<String, dynamic>>("record", item)!));
        }
      }
    }
    return ProxySystem2MemberGameRecordDetailPostRespModel(
  ...
  int pageNum = 0;
  int pageSize = 0;
  List<ProxySystem2MemberGameRecordDetailPostRespModel_Record> record;
  Object summary;
  int totalPage = 0;
  int totalRecord = 0;
...
class ProxySystem2MemberGameRecordDetailPostRespModel_Record {
  ProxySystem2MemberGameRecordDetailPostRespModel_Record({
  ...
  factory ProxySystem2MemberGameRecordDetailPostRespModel_Record.fromJson(Map<String, dynamic> jsonRes) {
    final List<ProxySystem2MemberGameRecordDetailPostRespModel_Detail>? detail = jsonRes['detail'] is List ? <ProxySystem2MemberGameRecordDetailPostRespModel_Detail>[] : null;
    if (detail != null) {
      for (final dynamic item in jsonRes['detail']!) {
        if (item != null) {
          detail
              .add(ProxySystem2MemberGameRecordDetailPostRespModel_Detail.fromJson(asT<Map<String, dynamic>>("detail", item)!));
        }
      }
    }
    return ProxySystem2MemberGameRecordDetailPostRespModel_Record(
  ...
  String createAt = '';
  List<ProxySystem2MemberGameRecordDetailPostRespModel_Detail> detail;
  String id = '';
  String matchName = '';
  double maxWin = 0.0;
  String memberName = '';
...
class ProxySystem2MemberGameRecordDetailPostRespModel_Detail {
  ProxySystem2MemberGameRecordDetailPostRespModel_Detail({
  ...
  factory ProxySystem2MemberGameRecordDetailPostRespModel_Detail.fromJson(Map<String, dynamic> jsonRes) => ProxySystem2MemberGameRecordDetailPostRespModel_Detail(
