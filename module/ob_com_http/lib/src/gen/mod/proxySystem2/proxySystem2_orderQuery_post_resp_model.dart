...
class ProxySystem2OrderQueryPostRespModel {
  ProxySystem2OrderQueryPostRespModel({
  ...
  factory ProxySystem2OrderQueryPostRespModel.fromJson(
      Map<String, dynamic> jsonRes) {
    final List<ProxySystem2OrderQueryPostRespModel_Record>? record = jsonRes['record'] is List ? <ProxySystem2OrderQueryPostRespModel_Record>[] : null;
    if (record != null) {
      for (final dynamic item in jsonRes['record']!) {
        if (item != null) {
          record
              .add(ProxySystem2OrderQueryPostRespModel_Record.fromJson(asT<Map<String, dynamic>>("record", item)!));
        }
      }
    }
    return ProxySystem2OrderQueryPostRespModel(
  ...
  int pageNum = 0;
  int pageSize = 0;
  List<ProxySystem2OrderQueryPostRespModel_Record> record;
  Object summary;
  int totalPage = 0;
  int totalRecord = 0;
...
class ProxySystem2OrderQueryPostRespModel_Record {
  ProxySystem2OrderQueryPostRespModel_Record({
  ...
  factory ProxySystem2OrderQueryPostRespModel_Record.fromJson(Map<String, dynamic> jsonRes) {
    final List<ProxySystem2OrderQueryPostRespModel_Detail>? detail = jsonRes['detail'] is List ? <ProxySystem2OrderQueryPostRespModel_Detail>[] : null;
    if (detail != null) {
      for (final dynamic item in jsonRes['detail']!) {
        if (item != null) {
          detail
              .add(ProxySystem2OrderQueryPostRespModel_Detail.fromJson(asT<Map<String, dynamic>>("detail", item)!));
        }
      }
    }
    return ProxySystem2OrderQueryPostRespModel_Record(
  ...
  String createAt = '';
  List<ProxySystem2OrderQueryPostRespModel_Detail> detail;
  String id = '';
  String matchName = '';
  double maxWin = 0.0;
  String memberName = '';
...
class ProxySystem2OrderQueryPostRespModel_Detail {
  ProxySystem2OrderQueryPostRespModel_Detail({
  ...
  factory ProxySystem2OrderQueryPostRespModel_Detail.fromJson(Map<String, dynamic> jsonRes) => ProxySystem2OrderQueryPostRespModel_Detail(
