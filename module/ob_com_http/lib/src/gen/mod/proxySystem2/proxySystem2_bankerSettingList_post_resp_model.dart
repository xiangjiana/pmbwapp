...
class ProxySystem2BankerSettingListPostRespModel {
  ProxySystem2BankerSettingListPostRespModel({
  ...
  factory ProxySystem2BankerSettingListPostRespModel.fromJson(
      Map<String, dynamic> jsonRes) {
    final List<ProxySystem2BankerSettingListPostRespModel_Record>? record = jsonRes['record'] is List ? <ProxySystem2BankerSettingListPostRespModel_Record>[] : null;
    if (record != null) {
      for (final dynamic item in jsonRes['record']!) {
        if (item != null) {
          record
              .add(ProxySystem2BankerSettingListPostRespModel_Record.fromJson(asT<Map<String, dynamic>>("record", item)!));
        }
      }
    }
    return ProxySystem2BankerSettingListPostRespModel(
  ...
  int pageNum = 0;
  int pageSize = 0;
  List<ProxySystem2BankerSettingListPostRespModel_Record> record;
  Object summary;
  int totalPage = 0;
  int totalRecord = 0;
...
class ProxySystem2BankerSettingListPostRespModel_Record {
  ProxySystem2BankerSettingListPostRespModel_Record({
  ...
  factory ProxySystem2BankerSettingListPostRespModel_Record.fromJson(Map<String, dynamic> jsonRes) {
    final List<ProxySystem2BankerSettingListPostRespModel_SettingMemberList>? settingMemberList =
        jsonRes['settingMemberList'] is List ? <ProxySystem2BankerSettingListPostRespModel_SettingMemberList>[] : null;
    if (settingMemberList != null) {
      for (final dynamic item in jsonRes['settingMemberList']!) {
        if (item != null) {
          settingMemberList.add(ProxySystem2BankerSettingListPostRespModel_SettingMemberList.fromJson(
              asT<Map<String, dynamic>>("settingMemberList", item)!));
        }
      }
    }
    return ProxySystem2BankerSettingListPostRespModel_Record(
  ...
  List<ProxySystem2BankerSettingListPostRespModel_SettingMemberList> settingMemberList;
...
class ProxySystem2BankerSettingListPostRespModel_SettingMemberList {
  ProxySystem2BankerSettingListPostRespModel_SettingMemberList({
  ...
  factory ProxySystem2BankerSettingListPostRespModel_SettingMemberList.fromJson(Map<String, dynamic> jsonRes) =>
      ProxySystem2BankerSettingListPostRespModel_SettingMemberList(
