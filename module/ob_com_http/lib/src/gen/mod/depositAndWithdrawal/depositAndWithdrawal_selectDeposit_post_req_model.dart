...
class DepositAndWithdrawalSelectDepositPostReqModel {
  DepositAndWithdrawalSelectDepositPostReqModel({
  ...
  factory DepositAndWithdrawalSelectDepositPostReqModel.fromJson(
    ...
    return DepositAndWithdrawalSelectDepositPostReqModel(
