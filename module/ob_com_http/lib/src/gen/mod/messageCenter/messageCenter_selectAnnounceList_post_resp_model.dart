...
class MessageCenterSelectAnnounceListPostRespModel {
  MessageCenterSelectAnnounceListPostRespModel({
    required this.data,
  });

  factory MessageCenterSelectAnnounceListPostRespModel.fromJson(
      Map<String, dynamic> jsonRes) {
    final List<MessageCenterSelectAnnounceListPostRespModelData>? data = jsonRes['data'] is List ? <MessageCenterSelectAnnounceListPostRespModelData>[] : null;
    if (data != null) {
      for (final dynamic item in jsonRes['data']!) {
        if (item != null) {
          data.add(MessageCenterSelectAnnounceListPostRespModelData.fromJson(asT<Map<String, dynamic>>("data", item)!));
        }
      }
    }
    return MessageCenterSelectAnnounceListPostRespModel(
      data: data == null ? [] : data,
    );
  }

  List<MessageCenterSelectAnnounceListPostRespModelData> data;
...
class MessageCenterSelectAnnounceListPostRespModelData {
  MessageCenterSelectAnnounceListPostRespModelData({
  ...
  factory MessageCenterSelectAnnounceListPostRespModelData.fromJson(Map<String, dynamic> jsonRes) => MessageCenterSelectAnnounceListPostRespModelData(
