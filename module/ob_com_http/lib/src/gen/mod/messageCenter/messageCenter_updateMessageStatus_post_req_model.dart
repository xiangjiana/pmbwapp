...
class MessageCenterUpdateMessageStatusPostReqModel {
  MessageCenterUpdateMessageStatusPostReqModel({
    required this.messageIds,
    required this.messageType,
  });

  factory MessageCenterUpdateMessageStatusPostReqModel.fromJson(
    ...
    return MessageCenterUpdateMessageStatusPostReqModel(
