...
class GameQueryMerchantDyPostRespModel {
  GameQueryMerchantDyPostRespModel({
    required this.code,
    required this.msg,
    required this.data,
  });

  factory GameQueryMerchantDyPostRespModel.fromJson(
    ...
    return GameQueryMerchantDyPostRespModel(
