...
import '../../utils/type_convert.dart';''';
  static const String propertyString = '  {0} {1} = {2};';
  static const String propertyStringObject = '  {0} {1} ;';
  ...
  static String setProperty(
      String typeString, String setName, DartProperty item, String? className) {
    if (typeString == "is") {
      return '$setName :${"jsonRes['${item.key}']"}==null? Map<String, dynamic>(): ${getUseAsT(getDartTypeString(item.type, item), "jsonRes['${item.key}']", item.key)},';
    } else {
      return '$setName :${"jsonRes['${item.key}']"}==null? ${typeString}: ${getUseAsT(getDartTypeString(item.type, item), "jsonRes['${item.key}']", item.key)},';
    }
  ...
  static const String setObjectProperty =
      '    {0} :jsonRes["{1}"]==null? {2}.fromJson({}): {3} {2}.fromJson(asT<Map<String, dynamic>>("{1}",jsonRes["{1}"]){4}),';
  ...
  static String propertySOJB(PropertyAccessorType type) {
    switch (type) {
      case PropertyAccessorType.none:
        return propertyStringObject;
      case PropertyAccessorType.final_:
        return propertyStringFinal;
      // case PropertyAccessorType.get_:
      //   return propertyStringGet;
  ...
  static const String classToClone =
      '\n{0} clone() => {0}.fromJson(asT<Map<String, dynamic>>("{1}",jsonDecode(jsonEncode(this))){1});\n';
...
T? asT<T extends Object?>(dynamic value, [T? defaultValue]) {
 ...
 ''';
  ...
  static String getUseAsT(String? par1, String par2, String key) {
    String asTString = 'asT<$par1>("$key",$par2)';
