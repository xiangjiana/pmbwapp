...
import 'package:ob_com_base/ob_com_base.dart' as com_base hide Navigator;
...
class DepositDropDown extends StatelessWidget {
  ...
  const DepositDropDown({Key? key, required this.result}) : super(key: key);
                  ...
                  com_base.LocaleUtils.isLocale
                      ? SizedBox(
                          ...
                          child: Wrap(
                            spacing: 8.w,
                            runSpacing: 6.w,
                            children: DEPOSIT_STATUS_FILTER_DIC.entries
                                .map(
                                  (e) => GestureDetector(
                                    onTap: () => Navigator.of(context).maybePop(
