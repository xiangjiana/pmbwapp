...
import 'nested_page_view_utils.dart';
...
class _NestedTabBarViewState extends State<NestedTabBarView> {
  ...
  late NestedPageViewUtils _pageViewScrollUtils;
  ...
  void didChangeDependencies() {
    ...
    _pageViewScrollUtils = NestedPageViewUtils(_pageController);
  }
  ...
  bool _handleScrollNotification(ScrollNotification notification) {
    ...
    if (notification.depth != 0) {
      return _pageViewScrollUtils.handleNotification(notification);
    }
