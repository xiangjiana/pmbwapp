...
class RectangleBorderControl extends ShapeBorder {

  const RectangleBorderControl({
    this.leftSide,
    this.rightSide,
    this.topSide,
    this.bottomSide,
  ...
  ShapeBorder scale(double t) {
    return new RectangleBorderControl(
  ...
  ShapeBorder? lerpFrom(ShapeBorder? a, double t) {
    assert(t != null);
    if (a is RectangleBorderControl) {
      return new RectangleBorderControl(
  ...
  ShapeBorder? lerpTo(ShapeBorder? b, double t) {
    assert(t != null);
    if (b is RectangleBorderControl) {
      return new RectangleBorderControl(
