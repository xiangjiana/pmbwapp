...
class ExtendedSliverAppbar extends StatelessWidget {
  const ExtendedSliverAppbar({
    ...
    this.isOpacityHideOrShow = false,
  ...
  /// By default, the value of isOpacityHideOrShow is false.
  final bool isOpacityHideOrShow;
  ...
  Widget build(BuildContext context) {
    ...
    return SliverPinnedPersistentHeader(
      delegate: _ExtendedSliverAppbarDelegate(
        ...
        isOpacityHideOrShow: isOpacityHideOrShow,
      ...
      child: ClipRect(
        child: Stack(
          children: <Widget>[
            ...
            Positioned(
              child: isOpacityHideOrShow ? toolbar : SizedBox(),
              top: 0,
              left: 0,
              right: 0,
            ),
