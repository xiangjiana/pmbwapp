...
class HoveringHeaderList extends StatefulWidget {
  ...
  HoveringHeaderList(
      ...
      Key? key, this.enablePullUp = false, this.onRefresh, this.onLoading, required this.refreshController})
      : assert(
...
class HoveringHeaderListState extends State<HoveringHeaderList> {
  ...
  late HoveringHeaderVM _hoverVM;

  ///section : HoverOffsetInfo
  late Map<int, HoveringOffsetInfo> _hoverOffsetInfoMap;
  ...
  _buildSectionList() {
    return SectionList(
      ...
      key: _sectionListKey, refreshController: widget.refreshController,
