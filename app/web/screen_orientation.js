(function rotate() {
     ...
     function createPd() {
          if (document.getElementById('preventTran') === null) {
               ...
               p.innerHTML = languageData&&languageData.for_good_experience||'为了您的良好体验';
               p.appendChild(br);
               p.innerHTML += languageData&&languageData.keep_screen_vertical||'请将手机/平板竖屏操作';
               pd.appendChild(p);
          }
     }
     ...
     window.onorientationchange = function () {
          ...
          if (orientation == 0 || orientation == 180) {
               //屏幕旋转横屏隐藏键盘，同时可以避免旋转回来之后页面一些展示的异常
               $("input", $($("flt-glass-pane")[0].shadowRoot)).each((_, e) => {
