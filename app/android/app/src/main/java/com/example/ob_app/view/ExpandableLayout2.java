...
public class ExpandableLayout2 extends ConstraintLayout {
    ...
    public ExpandableLayout2(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ExpandableLayout2);
            duration = a.getInt(R.styleable.ExpandableLayout2_el_duration, DEFAULT_DURATION);
            expansion = a.getBoolean(R.styleable.ExpandableLayout2_el_expanded, false) ? 1 : 0;
            orientation = a.getInt(R.styleable.ExpandableLayout2_android_orientation, VERTICAL);
            parallax = a.getFloat(R.styleable.ExpandableLayout2_el_parallax, 1);
            a.recycle();
