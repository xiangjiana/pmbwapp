...
/// This sample shows the implementation of [ObTabBar] and [TabBarView] using a [DefaultTabController].
...
/// [ObTabBar] can also be implmented by using a [TabController] which provides more options
/// to control the behavior of the [ObTabBar] and [TabBarView]. This can be used instead of
...
///  * [ObTabBar], which is used to display the [Tab] that corresponds to each page of the [TabBarView].
class ObTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// and the entire [ObTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  /// An optional callback that's called when the [ObTabBar] is tapped.
  ///
  ...
  /// How the [ObTabBar]'s scroll view should respond to user input.
  ///
  ...
  @override
  _ObTabBarState createState() => _ObTabBarState();
}

class _ObTabBarState extends State<ObTabBar> {
  ...
  @override
  void didUpdateWidget(ObTabBar oldWidget) {
