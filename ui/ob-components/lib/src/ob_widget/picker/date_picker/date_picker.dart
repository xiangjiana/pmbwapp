...
class CupertinoDatePicker extends StatefulWidget {
  ...
  CupertinoDatePicker({
    ...
    this.datePickerPadSize = _kDatePickerPadSize,
...
class _CupertinoDatePickerDateState extends State<CupertinoDatePicker> {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < columnWidths.length; i++) {
      ...
      EdgeInsets padding = EdgeInsets.only(right: widget.datePickerPadSize);
      if (textDirectionFactor == -1)
        padding = EdgeInsets.only(left: widget.datePickerPadSize);
